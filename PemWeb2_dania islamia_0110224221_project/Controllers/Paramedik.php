...
class Paramedik
{
    ...
    public function index()
    {
        $stmt = $this->pdo->query("SELECT 
            p.*, uk.nama as nama_unit_kerja, uk.keterangan as keterangan_unit
            FROM paramedik p
    ...
    public function update($id, $data)
    {
        $sql = "UPDATE paramedik 
                SET nama=:nama, gender=:gender, tmp_lahir=:tmp_lahir, tgl_lahir=:tgl_lahir, kategori=:kategori, 
                    telpon=:telpon, alamat=:alamat, unit_kerja_id=:unit_kerja_id 
                WHERE id=:id";
        $stmt = $this->pdo->prepare($sql);
